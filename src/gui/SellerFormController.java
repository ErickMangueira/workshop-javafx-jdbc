...
public class SellerFormController implements Initializable {
	...
	private List<DataChangeListeners> dataChangeListenrs = new ArrayList<>();
	...
	public void setDpartmentService(SellerService service) {
	...
	private void notifyDataChangeListeners() {
		for (DataChangeListeners listener : dataChangeListenrs) {
